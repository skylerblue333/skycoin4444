...
| The selected tester journey matches `BETA_SCOPE.md`.                                                                                       | Release note naming the approved course or creator workflow. | Product owner               | [ ]      |
...
| Persistence, migrations, backups, consent, privacy notice, and account deletion/support behavior are verified before accepting user data.               | Deployment and operational record.                                | Data owner                      | [ ]      |
...
| One approved course or creator journey completes.   | The selected end-to-end workflow succeeds without financial or live-Web3 operations.                              | QA owner                  | [ ]      |
