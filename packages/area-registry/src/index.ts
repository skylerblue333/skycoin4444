...
const verifiedAreaNotes: Readonly<Record<string, string>> = {
  wallet:
    "Official TRUMP Solana metadata and unsigned transfer-intent validation are available in server/features/tokenRegistry; wallet custody, signing, and broadcast remain disabled.",
  skychain:
    "The ecosystem records the Official TRUMP Solana mainnet boundary as metadata-only integration evidence; live chain execution remains disabled.",
};
