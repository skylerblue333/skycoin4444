...
import { betaFeedback, courseProgress, creatorEvidenceDrafts, discoveryBookmarks, posts, privacyRequests, searchHistory } from "../../drizzle/schema";
import { db } from "../db";
...
export const activityEvidenceRouter = router({
  list: protectedProcedure.query(async ({ ctx }) => {
    ...
    const [postRows, courseRows, feedbackRows, bookmarkRows, historyRows, creatorRows, privacyRows] = await Promise.all([
