...
Install Node.js 22+, pnpm 11+, and Docker Desktop or Docker Engine with Compose. Clone the canonical repository and install dependencies:

```bash
gh repo clone skylerblue333/skycoin4444
cd skycoin4444
