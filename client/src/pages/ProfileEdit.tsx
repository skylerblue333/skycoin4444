...
const THEME_PRESETS = [
  {
    id: "psychedelic",
    name: "Psychedelic",
    colors: ["#bf00ff", "#ff006e", "#00d4ff", "#ff6b00"],
    desc: "Tie-dye LSD drip",
  },
  {
    id: "cyber",
    name: "Cyber Void",
    colors: ["#00d4ff", "#7c3aed", "#1e1b4b", "#0f172a"],
    desc: "Dark cyber aesthetic",
  },
  {
    id: "gold",
    name: "Gold Rush",
    colors: ["#f5a623", "#ff6b00", "#1a0a00", "#0f0800"],
    desc: "Molten gold & orange",
  },
  {
    id: "neon",
    name: "Neon Night",
    colors: ["#ff006e", "#00ff88", "#0a0a0a", "#111111"],
    desc: "Classic neon vibes",
  },
  {
    id: "ocean",
    name: "Deep Ocean",
    colors: ["#00d4ff", "#0066ff", "#001a33", "#000d1a"],
    desc: "Deep sea blues",
  },
  {
    id: "aurora",
    name: "Aurora",
    colors: ["#00ff88", "#00d4ff", "#bf00ff", "#0a0a1a"],
...
export default function ProfileEdit() {
  ...
  const uploadAvatar = trpc.user.uploadAvatar.useMutation({
    onSuccess: (data, variables) => {
      ...
      toast.success(
        `${field === "avatar" ? "Profile photo" : "Banner"} updated!`
      );
    },
    onError: err => {
  ...
  const fieldStatus = (field: string) => {
    ...
    if (savedFields.has(field))
      return (
        <CheckCircle
          className="w-3 h-3"
          style={{ color: "oklch(0.80 0.22 145)" }}
        />
      );
    return null;
  };
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all flex items-center justify-center">
          <div
            className="opacity-0 group-hover:opacity-100 transition-all flex items-center gap-2 px-4 py-2 rounded-xl text-white text-sm font-medium"
            style={{ background: "rgba(0,0,0,0.6)" }}
          >
            <Camera className="w-4 h-4" />
            {uploadAvatar.isPending && uploadAvatar.variables?.type === "banner"
              ? "Uploading..."
              : "Change Banner"}
          </div>
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4 pb-16">
        ...
        <div className="relative -mt-16 mb-6 flex items-end gap-4">
          <div
            ...
            style={{
              border: "3px solid oklch(0.72 0.28 305)",
          ...
          >
            ...
            {uploadAvatar.isPending &&
              uploadAvatar.variables?.type === "avatar" && (
          ...
          <div className="pb-2">
            <h1 className="text-2xl font-bold text-white">
              {form.displayName || (user as any)?.name || "Your Name"}
            </h1>
            <p className="text-sm" style={{ color: "oklch(0.55 0.025 275)" }}>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          <TabsList
            className="w-full"
            style={{ background: "oklch(0.12 0.025 270)" }}
          >
            <TabsTrigger value="profile" className="flex-1">
              <User className="w-4 h-4 mr-1" /> Profile
            </TabsTrigger>
            <TabsTrigger value="social" className="flex-1">
              <Globe className="w-4 h-4 mr-1" /> Social
            </TabsTrigger>
          ...
          <TabsContent value="profile" className="space-y-4">
            <Card
              style={{
                background: "oklch(0.10 0.025 270)",
                border: "1px solid oklch(0.72 0.28 305 / 0.20)",
              }}
            >
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.45 0.015 275)" }}
                  >
                    {form.bio.length}/500
                  </p>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.45 0.015 275)" }}
                  >
                    This address will be shown on your public profile for tips
                    and payments.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "oklch(0.55 0.025 275)" }}
                  >
                    Connect your wallet to enable on-chain features, staking,
                    and token rewards.
                  </p>
                  <Button
                ...
                <div className="grid grid-cols-2 gap-3">
                  {THEME_PRESETS.map(theme => (
                    <button
                      key={theme.id}
                      onClick={() =>
                        setForm(f => ({ ...f, selectedTheme: theme.id }))
                      }
                      className="p-3 rounded-xl text-left transition-all"
                      style={{
                        background:
                          form.selectedTheme === theme.id
                            ? "oklch(0.72 0.28 305 / 0.20)"
                            : "oklch(0.13 0.025 275)",
