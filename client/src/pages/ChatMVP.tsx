...
type ActionType =
  "tip" | "request_service" | "create_listing" | "match_request" | "ai_task";

const ACTION_QUICK_BUTTONS: {
  type: ActionType;
  label: string;
...
const DEMO_CONVERSATIONS = [
  {
    ...
    name: "NOVA AI",
    avatar: "🤖",
    lastMessage: "I found 3 designers for you",
    unread: 2,
    isAI: true,
    online: true,
  },
  ...
  },
  {
    ...
    name: "Creator Hub",
    avatar: "⭐",
    lastMessage: "New collab opportunity",
    unread: 0,
    isAI: false,
    online: true,
  },
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      content:
        "Hey! I'm NOVA, your AI assistant. I can help you earn money, find services, send payments, and more. Try typing /find designer or /tip 20 to see what I can do.",
      senderId: 0,
      senderName: "NOVA AI",
    ...
    {
      id: 2,
      content: "That's amazing! Can you find me a logo designer for $50?",
        ...
        <div className="p-3 border-t border-border/50 grid grid-cols-4 gap-1">
          {[
            ...
            <Link
              key={item.label}
              href={item.href}
              className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-secondary/30 transition-colors text-muted-foreground hover:text-foreground"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="px-4 py-3 border-b border-border/50 flex items-center justify-between bg-background/80 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center text-base ${selectedConv?.isAI ? "bg-gradient-to-br from-purple-500 to-primary" : "bg-secondary"}`}
              >
                {selectedConv?.isAI ? (
          ...
          {messages.map(msg => {
            ...
            return (
              ...
              >
                {!isOwn && (
                  <div
                    className={`w-7 h-7 rounded-full shrink-0 flex items-center justify-center text-xs ${isAI ? "bg-gradient-to-br from-purple-500 to-primary" : "bg-secondary"}`}
                  >
                ...
                >
                    ...
                    {isAI && msg.content.includes("Shall I send payment") && (
                      <div className="flex gap-2 mt-2">
                        <button
                          onClick={() => {
                            toast.success(
                              "Payment sent to PixelPro — project started!"
                            );
                            addSystemMessage(
                              "✅ $45 sent to PixelPro · Project #4821 started"
                            );
                          }}
                  ...
                  <div
                    className={`flex items-center gap-1 text-xs text-muted-foreground ${isOwn ? "flex-row-reverse" : ""}`}
                  >
                    <span>
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="flex-1 relative">
              <input
                ...
                placeholder={
                  selectedConv?.isAI
                    ? "Ask NOVA anything... or type / for commands"
                    : "Message..."
                }
              />
              <button
