      ...
      <div className="relative overflow-hidden border-b border-slate-800/60">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <div className="flex gap-1.5">
              <button type="button" onClick={() => setSortMode("value")} className={`px-2.5 py-1.5 rounded-lg text-xs font-semibold border ${sortMode === "value" ? "border-cyan-400/50 bg-cyan-400/15 text-cyan-200" : "border-slate-700/40 bg-slate-800/60 text-slate-500"}`}>Value</button>
              <button type="button" onClick={() => setSortMode("alpha")} className={`px-2.5 py-1.5 rounded-lg text-xs font-semibold border ${sortMode === "alpha" ? "border-cyan-400/50 bg-cyan-400/15 text-cyan-200" : "border-slate-700/40 bg-slate-800/60 text-slate-500"}`}>A–Z</button>
            </div>

            <button type="button" onClick={() => setShortlistOnly(current => !current)} className={`px-2.5 py-1.5 rounded-lg text-xs font-semibold border ${shortlistOnly ? "border-amber-400/50 bg-amber-400/15 text-amber-200" : "border-slate-700/40 bg-slate-800/60 text-slate-500"}`}>
