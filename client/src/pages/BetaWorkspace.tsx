 ...
 */
import { Activity, ArrowRight, Bell, BookOpen, Boxes, CheckCircle2, FileText, FileWarning, Gauge, MessageSquare, Radio, ScanSearch, ShieldCheck, Sparkles, UserRound, Users } from "lucide-react";
...
const JOURNEYS = [
  ...
  { title: "Discovery Center", route: "/discovery-center", detail: "Search approved records, save browser-local references, and review your own notifications.", status: "Working", icon: Bell, tone: "text-blue-300" },
] as const;
