 ...
 */
import { Activity, ArrowRight, Bell, BookOpen, Boxes, CheckCircle2, FileText, FileWarning, Gauge, History, MessageSquare, Radio, ScanSearch, Settings2, ShieldCheck, Sparkles, UserRound, Users } from "lucide-react";
...
const JOURNEYS = [
  ...
  { title: "Activity Evidence", route: "/activity-evidence", detail: "Review your own persisted lessons, posts, feedback, discovery, and creator events without inferred analytics.", status: "Evidence view", icon: History, tone: "text-lime-300" },
  { title: "Discovery Center", route: "/discovery-center", detail: "Search approved records, save durable references, and review your own notifications.", status: "Working", icon: Bell, tone: "text-blue-300" },
  { title: "Notification preferences", route: "/notification-preferences", detail: "Control your in-app notification policy with account-owned settings and safe defaults.", status: "Working", icon: Settings2, tone: "text-violet-300" },
] as const;
