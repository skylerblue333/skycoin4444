...
export default function SchoolCertificate() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(
      `https://shadowchat-xvi6fbz3.manus.space/school/certificate/${params.id}`
    );
    setCopied(true);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-10 max-w-4xl">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-8 shadow-2xl">
          ...
          <div className="relative z-10 p-12 text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-primary/20 border-2 border-primary/50 flex items-center justify-center text-xl">
                🚀
              </div>
              <div>
            ...
            <div className="text-yellow-400/60 text-sm tracking-widest uppercase mb-4 font-mono">
            ...
            <div className="text-muted-foreground text-sm mb-8">
              with a score of{" "}
              <span className="text-purple-400 font-bold">94%</span> on June 17,
              2026
            </div>
            ...
            <div className="mt-6 text-xs text-muted-foreground/50 font-mono">
              {shortHash}
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="rounded-xl border border-border/50 bg-card/30 p-5">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              This certificate is permanently recorded on-chain and can be
              verified by anyone.
            </p>
          ...
          <div className="rounded-xl border border-border/50 bg-card/30 p-5">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Share your certificate on social media and with employers.
            </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            { label: "Completion Date", value: "Jun 17, 2026" },
            { label: "Time Spent", value: "11h 24m" },
            { label: "Quiz Score", value: "94%" },
            ...
            {[
              {
                ...
                emoji: "💎",
                level: "Intermediate",
                href: "/school/course/defi-mastery",
              },
              {
                title: "Solidity Smart Contracts",
                emoji: "⚡",
                level: "Intermediate",
                href: "/school/course/solidity-smart-contracts",
              },
              {
                title: "Crypto Security",
                emoji: "🛡️",
                level: "Advanced",
                href: "/school/course/crypto-security",
              },
            ].map(c => (
