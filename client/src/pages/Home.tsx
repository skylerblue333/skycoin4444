 ...
 */
import { ArrowRight, BookOpen, Boxes, MessageSquare, Radio, ShieldCheck, Users } from "lucide-react";
    ...
    <main className="min-h-screen bg-background">
      <div className="container mx-auto max-w-7xl px-4 py-10">
        <header className="flex flex-col gap-6 border-b pb-10 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-3"><Link href="/beta-catalog"><Button>View beta catalog <ArrowRight className="ml-2 h-4 w-4" /></Button></Link><Link href="/beta-feedback"><Button variant="outline">Send beta feedback</Button></Link></div>
        </header>
